        ...
        if AB_range[0] < abs(AB) < AB_range[1]:
            if BC_range[0] < abs(BC) < BC_range[1]:
                if CD_range[0] < abs(CD) < CD_range[1]:
                    ...
                    plt.title(label=f'{total}: Bat Bullish  Pattern; EUR/USD')
                    plt.show()
                    ...
                    plt.axvline(np.arange(start, i)[-1], c='g', ls='--', label='End of pattern')
                    plt.plot(current_idx, current_pattern, c='r')
                    plt.title(label=f'{total}: Bat Bullish Pattern+24h; EUR/USD')
                    plt.show()
        ...
        if AB_range[0] < abs(AB) < AB_range[1]:
            if BC_range[0] < abs(BC) < BC_range[1]:
                if CD_range[0] < abs(CD) < CD_range[1]:
                    ...
                    plt.axvline(np.arange(start, i)[-1], c='g', ls='--', label='End of pattern')
                    plt.plot(current_idx, current_pattern, c='r')
                    plt.title(label=f'{total}: Bat Bearish Pattern; EUR/USD')
                    plt.show()
                    ...
                    plt.axvline(np.arange(start, i)[-1], c='g', ls='--', label='End of pattern')
                    plt.plot(current_idx, current_pattern, c='r')
                    plt.title(label=f'{total}: Bat Bearish Pattern+24h; EUR/USD')
                    plt.show()

print(f'Total number of Bat Bullish patterns: {count_pattern_bullish}')
print(f'Total number of Bat Bearish patterns: {count_pattern_bearish}')
print(f'Total number of Bat patterns: {total}')
